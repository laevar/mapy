...
\lstinline!who!. 
\item Löschen von Variablen : \lstinline!clear <var>!;
...
\item \lstinline!inv(A)! berechnet die Inverse von $A$.\\

\item \lstinline!A'! oder \lstinline!ctranspose(A)! ergibt die
  komplex Transponierte von $A$. \\

\item \lstinline!A.'! oder \lstinline!transpose(A)! ist die Transponierte von $A$. \\

\item \lstinline!A^z! berechnet $\underbrace{A*A*\cdots *A}_{z-mal}$ (quadratische Matrizen)\\
