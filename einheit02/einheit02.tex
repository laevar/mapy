...
\end{lstlisting}
\begin{tabular}{cll}
a == b & gleich &   \mcode{0     1     0}\\
a \mcode{\~=} b & ungleich & \mcode{1     0     1}\\
a < b & kleiner & \mcode{0     0     1}\\
a > b & größer & \mcode{1     0     0}\\
a <= b & kleiner oder gleich & \mcode{0     1     1}\\
a >= b & größer oder gleich & \mcode{1     1     0}\\
\end{tabular}
\\
...
der {\it Ausdruck} wahr (\mcode{TRUE}) ist. 
