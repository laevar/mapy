...
\item Hierdurch k\"onnen Programme von Usern ohne MATLAB-Kenntnisse genutzt
  werden. Weiterhin kann dies die Benutzung auch für den Implementierer von numerischen Algorithmen hilfreich sein.
...
\item \mcode{h} ist der Handle des Objekts, dass die CallBack-Funktion
  aufruft. 
\item \mcode{ev_data} wird nicht ben\"otigt (ist reserviert).
