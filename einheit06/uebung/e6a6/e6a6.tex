\begin{aufg}[0]
Schauen Sie sich die Funktion \mcode{interpolation} (aus Vorlesung Einheit 04) an und nutzen sie den Profiler mit der Funktion $f(x) = x^2$.
...
\item Vergleichen Sie ebenso unsere selbstgebaute Polynom-Interpolation mit der eingebauten Interpolation (\mcode{polyfit}).
