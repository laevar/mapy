...
\title{Einführung in Matlab - Einheit 7}
...
\item Man kann aus C-Programmen heraus, den gro{\ss}en Befehlsumfang von
  MATLAB nutzen (einfaches Erstellen von Grafiken).
\end{itemize}
\end{frame}
...
\item Das Starten eines MATLAB-Fensters aus einem C-Programm heraus. Hier bindet
      man passende Bibliotheken ein: die sogenannte Engine.
\end{itemize}
\end{frame}
%
% Slide
...
\item Benutzen Sie die \mcode{mxGet} Funktionen, um die Daten von
...
Befehle und Pfade gelten f\"ur MATLAB 7 (R2009a).
