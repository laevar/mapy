...
\begin{itemize}
  \item Python code zu kompilieren\\
  \item C Funktionen aufzurufen\\
  \item Variablen mit C-Typen zu deklarieren.
\end{itemize}

Sie muss kompiliert werden.
...
Mit \isage{cdef} starten Zeilen die C-Funktionen importieren oder C-Typen deklarieren.

\end{frame}

\begin{frame}[fragile]\frametitle{Kompilieren}

Distutils - Ersetze \isage{<extensionname>} und \isage{<filename>.pyx}
  \begin{pyin}
