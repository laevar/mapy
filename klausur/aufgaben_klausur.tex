...
\emph{Hinweis:} Die \mcode{positions} können aus vereinfachungstechnischen Gründen weggelassen werden.
...
Default-Werte, falls diese nicht übergeben werde. Danach sollen alle Funktionen in einem 2D-Plot grafisch dargestellt werden.
\end{aufg}
...
\begin{aufg}{6}
Gegeben sei eine Datei \texttt{'dummy.csv'} mit folgendem Inhalt:
